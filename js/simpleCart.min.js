    ...
    var s = "string",
        ...
        C = function (q) {
                        ...
                        return (
                            b.each(function (c) {
                                ...
                                b.each(a, function (a, b, d) {
                                    k(a, s)
                                        ? a.match(/<=.*/)
                                            ? ((a = parseFloat(a.replace("<=", ""))), (c.get(d) && parseFloat(c.get(d)) <= a) || (g = !1))
                                            : a.match(/</)
                                            ? ((a = parseFloat(a.replace("<", ""))), (c.get(d) && parseFloat(c.get(d)) < a) || (g = !1))
                                            : a.match(/>=/)
                                            ? ((a = parseFloat(a.replace(">=", ""))), (c.get(d) && parseFloat(c.get(d)) >= a) || (g = !1))
            ...
            b.Item = function (a) {
                ...
                n += 1;
                for (c.id = c.id || 1 + n; !e(r[c.id]); ) (n += 1), (c.id = 1 + n);
                g.get = function (a, b) {
                    var d = !b;
            ...
            b.Item._ = b.Item.prototype = {
                ...
                price: function (a) {
                    return e(a)
                        ? parseFloat(this.get("price", !0).toString().replace(b.currency().symbol, "").replace(b.currency().delimiter, "") || 1)
                        : this.set("price", parseFloat(a.toString().replace(b.currency().symbol, "").replace(b.currency().delimiter, "")));
                },
                id: function () {
