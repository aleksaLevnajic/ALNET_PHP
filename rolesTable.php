      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="adminPanel.php">Roles Table</a>
          </div>
      ...
      <div class="col-md-12">   
        ...
        <div id="roles">
            <table class="table"> 
              ...
              ?>
                <tr>
                  <th scope="row"><?=$r->id_role?></th>
                  <td><input type="text" id="nameRole<?=$r->id_role?>" class="form-control" value="<?=$r->role_name?>"></td>
                  <td><a href="#" data-id="<?=$r->id_role?>" class="updateRole">Update</a></td>
                  <td><a href="#" data-id="<?=$r->id_role?>" class="deleteRole">Delete</a></td>
                </tr>
              <?php
                endforeach;
              ?>
